...
const SidebarItem = memo(({
  ...
  <div className="space-y-1">
    <button
      onClick={onClick}
      className={`w-full flex items-center ${isSidebarHovered ? 'px-4' : 'justify-center'} py-3 rounded-2xl group relative ${activeTab === label
        ? 'text-white'
        : 'text-gray-400 hover:text-white'
        }`}
      title={!isSidebarHovered ? label : ''}
    >
      <div className={`shrink-0 w-12 h-12 rounded-full flex items-center justify-center ${activeTab === label
            ...
            <div className="max-w-[1600px] mx-auto w-full">
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-2 mt-1">
                              <span className={`text-[10px] px-2 py-0.5 rounded-full font-black uppercase tracking-widest ${u.status === 'approved' ? 'bg-green-100 text-green-600' :
              ...
              {activeTab === 'Dashboard' && (
                <>
                  ...
                  <div className="table-container-3d !border-none !shadow-none w-full shadow-2xl">
                  ...
                  <div className="bg-white w-full rounded-[2.3rem] p-10 shadow-2xl mt-10">
                    {/* Main Title Section */}
                ...
                <div className="p-8 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between bg-white sticky top-0 z-10 gap-4">
                  ...
                  <div className="flex-1 max-w-md flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className={`px-4 py-3 rounded-xl font-bold transition-all flex items-center space-x-2 border ${showDuplicatesOnly
                  ...
                  <div className="flex items-center space-x-4">
                    <button
                      ...
                      className={`px-6 py-3 rounded-xl font-bold transition-all flex items-center space-x-2 ${selectedNtnRecords.length > 0 && !isDeletingBulk
                          ...
                          <tbody className="divide-y divide-gray-50">
                            {recordsWithDupInfo.length > 0 ? recordsWithDupInfo.map((record, idx) => {
                              ...
                              return (
                                <tr
                                  key={record.id}
                                  className={`hover:bg-gray-50/50 transition-colors group ${isNewGroup ? 'border-t-2 border-amber-200' : ''
                                ...
                                >
                                  ...
                                  <td className="p-4">
                                    <span className={`text-sm font-mono font-bold ${record.duplicateKey?.startsWith('ntn-') ? 'text-amber-600 bg-amber-100/50 px-1 rounded' : 'text-blue-600'
                                      }`}>
                                      {record.ntn || 'N/A'}
                                    </span>
                                  </td>
                                  <td className="p-4">
                                    <span className={`text-sm font-mono font-bold ${record.duplicateKey?.startsWith('cnic-') ? 'text-amber-600 bg-amber-100/50 px-1 rounded' : 'text-gray-500'
                                      }`}>
                                      {record.cnic || 'N/A'}
                                    </span>
                                  </td>
                                  <td className="p-4">
                                    <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${record.status === 'Active' ? 'bg-emerald-50 text-emerald-600' : 'bg-red-50 text-red-600'
                                      }`}>
                                      {record.status}
                                    </span>
                                  </td>
